...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20221203_axiosarchitecture_3508a6273c0d4ab28103_20221203161918_archive.zip';
        const ARCHIVE_SIZE       = '103909251';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '3508a62-03161918';
        const SECONDARY_PACKAGE_HASH = '91ae7a4-03161918';
        const VERSION            = '1.5.1';
